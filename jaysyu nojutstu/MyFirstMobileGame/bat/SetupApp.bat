...
:: Android packaging
set AND_CERT_NAME="MyFirstMobileGame"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\MyFirstMobileGame.p12
...
set IOS_PROVISION=cert\MyFirstMobileGame.mobileprovision
...
:: Output packages
set DIST_PATH=dist
set DIST_NAME=MyFirstMobileGame
